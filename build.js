(function() {
  ...
  const config = {
  "timestamp": "2025-12-14T02:54:47.796Z",
  "repo": {
    "user": "somiibo",
    "name": "tokautomator-website"
  },
  "environment": "production",
  "packages": {
    "web-manager": "4.0.36",
    "ultimate-jekyll-manager": "0.0.165"
  },
  "config": {
    "source": "dist",
    "destination": "/home/runner/work/tokautomator-website/tokautomator-website/_site",
    "collections_dir": "",
    ...
    "meta": {
      "title": "TikTok Bot - Get real followers, likes, and comments - {{ site.brand.name }}",
      "description": "Automate your TikTok activity with this free view bot, follow bot & comment bot. {{ site.brand.name }} is a follow bot and view generator all in one. Increase TikTok followers & views for free!",
    ...
    "brand": {
      "id": "tokautomator",
      "name": "Tok Automator",
      "description": "TikTok automation tool for growth",
      "type": "Corporation",
      "images": {
    ...
    "cloudflare": {
      "zone": "851d8f3005574ad4698a33d640b1a71f"
    },
    "download": {
      "mac": {
        "universal": "https://somiibo.com/download"
      },
      "windows": {
        "universal": "https://somiibo.com/download"
      },
      "linux": {
        "debian": "https://somiibo.com/download",
        "snap": "https://somiibo.com/download"
      },
      "ios": {
        "universal": "https://somiibo.com/download"
      },
    ...
    "random_id": 35,
    "canonical": {
      "url": "https://tokautomator.com/config.json",
      "path": "/config.json"
    }
  },
  "npm-build": "2025-12-14T02:54:47.796Z"
};
